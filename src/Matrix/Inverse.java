...
public class Inverse {
    ...
    // mengembalikan matriks m^-1, invers dari matriks m. matriks m harus berupa
    // matriks persegi dengan dimensi > 0
    public static Matrix inversiGaussJordan(Matrix m) {
        ...
        // diag == 0 ATAU maug.mat[i][i] == 0 (elemen diagonal matriks utama terdapat 0,
